...
export default async function PageModel({ params }: { params: { repo_id: string } }) {
  ...
  return (
    <div className="flex flex-1 flex-col gap-12 pt-12 ">
      <ModelHeader {...pick(model, ["repo_id", "name", "author", "link", "likes", "downloads"])} />
      <ModelResults
        withExternalLink
        results={pick(model, ["score", "arc", "hellaswag", "mmlu", "truthfulqa", "winogrande", "gsm8k"])}
      />
